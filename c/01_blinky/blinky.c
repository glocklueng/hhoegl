 ...
 *  Name: blinky.c
 *
 *  Purpose:	Test Program for STM32VLDiscovery - blinks the LEDs on
 *  and off *  at different rates
 *
 *  Green is 4 times slower than blue. Green is turned off if the button
 *  is pressed
 *
...
/*  Four vectors - the starting stack pointer value, code entry point and
